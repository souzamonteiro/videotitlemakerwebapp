...
# Script to generate all the icons for the Video Title Maker Web App

echo "Generating icons for the Video Title Maker Web App..."
...
{
  "name": "Video Title Maker",
  "short_name": "VideoTitleMaker",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "Edit and save your videos directly from your browser",
  "icons": [
    {
